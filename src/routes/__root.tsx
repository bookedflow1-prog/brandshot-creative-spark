  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h1 className="mt-3 text-display text-4xl text-foreground">Page not found</h1>
...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="text-display text-3xl text-foreground">Something went wrong</h1>
        <p className="mt-3 text-sm text-muted-foreground">
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "BrandShot AI turns one photo into professional-quality images, designs and videos. Simple to use, powerful under the hood." },
      { property: "og:title", content: "BrandShot AI — Create. Edit. Transform." },
      { property: "og:description", content: "Turn one photo into content that looks professionally made. AI photo, design and video studio for creators and businesses." },
